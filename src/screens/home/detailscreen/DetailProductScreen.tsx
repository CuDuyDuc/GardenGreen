...
const DetailProductScreen = ({ route, navigation }: any) => {
    ...
    const filteredProductArray = (value: String) => {//tìm sản phẩm tương ứng với id
    ...
    const handleData = () => {
        const specificKeyItem = filteredProductArray(idProduct).find(product => product !== undefined && product !== null);//tìm được sản phẩm tương ứng với id tìm tiếp xem có undefined hoặc null không
        if (specificKeyItem) {
    ...
    return (
        <ContainerComponent isScroll>
            ...
            <SectionComponent styles={{ justifyContent: 'center', height: 315 }}>
                <Swiper style={{}}
                    ...
                    {imageUrls.map((imageUrl, index) => (
                        <Image source={{ uri: imageUrl }} key={index} style={{ flex: 1 }} resizeMode="cover" />
                    ))}
                </Swiper>
            </SectionComponent>
            <SectionComponent>
                ...
                <SectionComponent>
                    <TextComponent text='Chi tiết sản phẩm' size={18} color={COLORS.BLACK} />
                    <View style={{
                        borderBottomWidth: 1,
                ...
                <SectionComponent>
                    <RowComponent justify='space-between'>
                        <TextComponent text='Kích cỡ' size={16} color={COLORS.HEX_LIGHT_GRAY} />
                        <TextComponent text={size} size={16} color={COLORS.HEX_LIGHT_GRAY} />
                    </RowComponent>
                    <View style={{
                        borderBottomWidth: 1,
                        borderBottomColor: 'gray',
                ...
                <SectionComponent>
                    <RowComponent justify='space-between'>
                        <TextComponent text='Xuất xứ' size={16} color={COLORS.HEX_LIGHT_GRAY} />
                        <TextComponent text={origin} size={16} color={COLORS.HEX_LIGHT_GRAY} />
                    </RowComponent>
                    <View style={{
                        borderBottomWidth: 1,
                        borderBottomColor: 'gray',
                ...
                <SectionComponent>
                    <RowComponent justify='space-between'>
                        <TextComponent text='Tình trạng' size={16} color={COLORS.HEX_LIGHT_GRAY} />
                        <TextComponent text={status + "sp"} size={16} color={COLORS.GREEN} />
                    </RowComponent>
                    <View style={{
                        borderBottomWidth: 1,
                        borderBottomColor: 'gray',
            ...
            <SectionComponent>
                <RowComponent justify='space-between'>
                    <TextComponent text={`Đã chọn ${quantity} sản phẩm`} color={COLORS.HEX_LIGHT_GRAY} size={14} />
                    <TextComponent text='Tạm tính' color={COLORS.HEX_LIGHT_GRAY} size={14} />
                </RowComponent>
            </SectionComponent>
            <SectionComponent>
                <RowComponent justify='space-between'>
                    <RowComponent justify='space-between' styles={{ flex: 0.5 }}>
                        <ButtonComponent
                            ...
                            text='-' type='#009245' textStyles={{ fontSize: 16 }} />
                        <TextComponent text={`${quantity}`} size={16} color={COLORS.BLACK} />
                        <ButtonComponent
                            onPress={handlePlus}
                            styles={{ width: 35, height: 35 }}
                            text='+' type='#009245' textStyles={{ fontSize: 16 }} />
