                ...
                <View style={{ marginStart: 10, maxWidth: 200 }} >
                    ...
                    <RowComponent justify='space-between'>
                        ...
                        {checkCartItem ? (
                            <View style={{ flexDirection: 'row' }}>
                                <TextComponent text={price} font={FONTFAMILY.poppins_bold} color={COLORS.BLACK} size={18} />
                                <TextComponent text='VNĐ' font={FONTFAMILY.poppins_bold} color={COLORS.GREEN} size={18} />
                            </View>
                        ) : undefined}
                    </RowComponent>
                    <View style={{ marginTop: 5 }}>
                        <RowComponent justify='space-between'>
                            ...
                            <ButtonComponent
                                styles={checkCartItem ? { width: 35, height: 35 } : { width: 30, height: 30, borderRadius: 8 }}
                                text='+' type='#009245' textStyles={{ fontSize: 16 }} onPress={onPressPlus} />
                        </RowComponent>
                    </View>
                </View>
            </RowComponent>
